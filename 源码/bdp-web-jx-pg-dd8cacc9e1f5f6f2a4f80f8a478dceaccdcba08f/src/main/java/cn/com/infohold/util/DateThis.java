 ...
 * leapYear
 * 
 * 注意事项: 日期格式为：xxxx-yy-zz (eg: 2018-12-05)
 *
 * 实例:
 *
 * @author pure
...
public class DateThis {
	...
	/**
	 * 功能：得到当前日期 格式为：xxxx-yy-zz (eg: 2018-12-05)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前月份月初 格式为：xxxx-yy-zz (eg: 2018-12-01)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前月份月底 格式为：xxxx-yy-zz (eg: 2018-12-31)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前月份上月初 格式为：xxxx-yy-zz (eg: 2018-12-01)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	public String thisEarlyMonth() {
		String strY = null;
		x = localTime.get(Calendar.YEAR);
	...
	/**
	 * 功能：得到当前月份上月底 格式为：xxxx-yy-zz (eg: 2018-12-31)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	public String thisEarlyMonthEnd() {
		String strY = null;
		String strZ = null;
		boolean leap = false;
		x = localTime.get(Calendar.YEAR);
	...
	/**
	 * 功能：得到当前季度季初 格式为：xxxx-yy-zz (eg: 2018-10-01)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前季度季末 格式为：xxxx-yy-zz (eg: 2018-12-31)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前年份年初 格式为：xxxx-yy-zz (eg: 2018-01-01)<br>
	 * 
	 * @return String
	 * @author pure
	 */
	...
	/**
	 * 功能：得到当前年份年底 格式为：xxxx-yy-zz (eg: 2018-12-31)<br>
	 * 
	 * @return String
	 * @author pure
	 */
