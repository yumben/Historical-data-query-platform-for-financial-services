...
(function (factory) {
  ...
  function getHoveredElement($clone, $dragElement, $movableElements) {
    ...
    for (var i = 0; i < $movableElements.length; i++) {
      ...
      horizontalMidPosition = offset.left + 0.5 * $currentElement.outerWidth();
      verticalMidPosition = offset.top + 0.5 * $currentElement.outerHeight();
      //horizontalMidPosition = offset.left + $currentElement.outerWidth();
      //verticalMidPosition = offset.top + $currentElement.outerHeight();
