...
$(function() {
	...
	function paramJson(valJson) {
		...
		var totalVar = $('#totalVar').attr("totalVar");
		if (selectPage == '') {
			selectPage = '10';
			curPageSize = 10;
	...
	function selectData() {
		...
		ajaxSendload('/bdp-web/easyQuery/selectEasyqueryData', params, function(data) {
			//console.log(JSON.stringify(data)+'查询回来的数据');
			...
			$("#totalVar").attr("objectList", objectList[0]);
	...
	//点击导出按钮
	function exportData() {
		var totalVar = parseInt($("#totalVar").attr("totalVar"));
		var objectlist = parseInt($("#totalVar").attr("objectlist"));
