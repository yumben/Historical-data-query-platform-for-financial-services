...
@Log4j2
@RestController
@RequestMapping("/easyTargetCatalog")
public class EasyTargetCatalogController {
	@Autowired
	...
	public JSONObject add(HttpServletRequest request) throws IOException {
		...
		try {
			...
			String result = serviceUrlServiceImpl.post(SERVICE_NAME, "/easyTargetCatalog/add", multiValueMap);
	...
	public JSONObject edit(HttpServletRequest request) throws IOException {
		...
		try {
			...
			Map<String, String> multiValueMap = new HashMap<String, String>();
			multiValueMap.put("param", param);
			String result = serviceUrlServiceImpl.post(SERVICE_NAME, "/easyTargetCatalog/edit", multiValueMap);
			jsonObject = JSONObject.parseObject(result);
		} catch (Exception e) {
			jsonObject.put("code", "-1");
			jsonObject.put("msg", e.getMessage());
	...
	public JSONObject delete(HttpServletRequest request) throws IOException {
		...
		try {
			...
			String result = serviceUrlServiceImpl.post(SERVICE_NAME, "/easyTargetCatalog/del", multiValueMap);
			jsonObject = JSONObject.parseObject(result);
		} catch (Exception e) {
			jsonObject.put("code", "-1");
			jsonObject.put("msg", e.getMessage());
	...
	public JSONObject select(HttpServletRequest request) {
		...
		try {
			...
			String result = serviceUrlServiceImpl.post(SERVICE_NAME, "/easyTargetCatalog/select", multiValueMap);
